...
We're back with the third installment of the space race series. In the [first article](/blog/the-new-space-race/), I explored how the space industry shifted from government monopoly to commercial playground. In the [second](/blog/the-new-space-race-ii-a-sea-of-debris/), I examined the growing debris crisis threatening our orbital environment. Today, I want to tackle another question: does all this rocket activity actually pollute?
...
- **Global aviation**: [roughly 1 billion tonnes of CO2 per year](https://www.sciencedirect.com/science/article/pii/S1352231020305689)
- **Global road transport**: about 6 billion tonnes per year
- **All rocket launches in 2024** (around 230 orbital attempts): approximately **70,000 tonnes of CO2**, or about **0.007% of aviation**
...
This is what actually keeps atmospheric scientists up at night. [Maloney and their colleagues](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2021JD036373) estimated that rockets deposited about 41 tonnes of black carbon in the stratosphere in 2019 alone. That sounds small, but the radiative forcing it produces is disproportionate to its mass.

[Ryan and their colleagues](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2021EF002612) modeled what happens if launch rates increase tenfold, a scenario that's looking increasingly plausible. Their findings: soot accumulation could cause **measurable hemispheric warming**, up to 0.5 degrees Celsius at polar regions in worst-case scenarios. [Dallas and their colleagues' comprehensive review](https://www.sciencedirect.com/science/article/pii/S0959652620305989) reached the same conclusion: **black carbon and alumina particles are the two most concerning rocket emissions**, not CO2.
...
Soot isn't the only stratospheric concern. Each Space Shuttle launch [deposited about 68 tonnes of HCl and 57 tonnes of aluminum oxide](https://www.tandfonline.com/doi/full/10.1080/14777620902768867) in the stratosphere. That chlorine participates in the exact same catalytic cycle that the Montreal Protocol was designed to stop for CFCs.

[Ryan and their colleagues' modeling](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2021EF002612) suggests that at 10 times 2019 launch rates, we'd see a **0.5 to 1% reduction in the global ozone column**, with larger depletions of 2 to 4% near the poles. [Larson and their colleagues](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1002/2016EF000399) separately modeled a fleet of reusable kerosene launchers and found localized ozone depletion of 1 to 2% at launch latitudes.

Here's what I find particularly troubling: **rocket emissions are simply not regulated by the [Montreal Protocol](https://ozone.unep.org/treaties/montreal-protocol).** There is currently no international regulatory framework governing cumulative stratospheric pollution from launches. The Outer Space Treaty of 1967, our primary governance document for space activities, doesn't address atmospheric emissions at all.
...
Then there's what happens when all those satellites come back down. [Murphy and their colleagues found in 2023](https://www.pnas.org/doi/10.1073/pnas.2313374120) that metals from spacecraft reentry now constitute roughly **10% of stratospheric aerosol particles**. If Starlink grows to its planned 42,000 satellites with 5-year lifespans, that's about [8,400 reentries per year](https://www.sciencedirect.com/science/article/abs/pii/S0273117720307663), each depositing aluminum oxide in the upper atmosphere. No regulations currently govern this either.
...
Brazil's [DETER deforestation monitoring system](https://www.climatepolicyinitiative.org/publication/deterring-deforestation-in-the-brazilian-amazon-environmental-monitoring-and-law-enforcement/), built on satellite data, contributed to a **70% reduction in Amazon deforestation** between 2004 and 2012. [MethaneSAT](https://www.methanesat.org), launched in 2024, now maps global methane emissions at unprecedented resolution. The Paris Agreement's monitoring framework would be crippled without satellite data.
...
_This concludes the space race series, at least for now. Space exploration clearly gives humanity extraordinary benefits, but like any powerful endeavor, it demands responsible stewardship. The question was never whether rockets pollute. It's whether we're paying attention._
